    ...
    <div class="containt">
        ...
        <div class="row">
            ...
            <div class="col-6">
                ...
                {!! Form::text('nom_visiteur',null,['class'=>"form-control @error('nom_visiteur') is-invalid @enderror",'value'=>"{{ old('nom_visiteur')}}"] )!!}



                @error('nom_visiteur')
                <div class="text-danger"> @error->first('nom_visiteur')</div>
                @enderror

            </div>
            <div class="col-6">
                {!! Form::label('title','Votre Email') !!}
                {!! Form::email('email_visiteur',null,['class'=>"form-control @error('email_visiteur') is-invalid @enderror",'value'=>"{{old('email_visiteur')}}"] )!!}


                @error('email_visiteur')
                <div class="text-danger"> @error->first('email_visiteur')</div>
                @enderror
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <select name="sujet_visiteur"  class="form-control select2 @error('sujet_visiteur') is-invalid @enderror" style="width: 100%;">
                ...
                @error(sujet_visiteur')
                <div class="text-danger"> @error->first('sujet_visiteur')</div>
                @enderror
        ...
        <div class="row">
            ...
            <div class="col">
                {!! Form::label('title','Votre message') !!}
                {!! Form::textarea('message_visiteur',null,['class'=>"form-control @error('message_visiteur') is-invalid @enderror",'value'=>"{{ old('message_visiteur')}}"] )!!}

                @error('message_visiteur')
                <div class="text-danger"> @error->first('message_visiteur')</div>
                @enderror
            </div>
